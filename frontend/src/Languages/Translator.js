import {httpGet} from './YandexHandlerMethods'
...
const key =  'trnsl.1.1.20200113T001347Z.da05fe3bfdc667ea.0fa6c688d13c416ed1cab21b1216064d4e6c7224';


//https://translate.yandex.net/api/v1.5/tr.json/detect?key=trnsl.1.1.20200113T001347Z.da05fe3bfdc667ea.0fa6c688d13c416ed1cab21b1216064d4e6c7224&text=enable
const  detectLang = (text) => {
    const response = `https://translate.yandex.net/api/v1.5/tr.json/detect?key=${key}&text=${text}`;
